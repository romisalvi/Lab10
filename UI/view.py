...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.dd = ft.Dropdown()
        self.btnRagg = ft.ElevatedButton(text="Calcola stati raggiungibili", on_click=self._controller.getStatiRagg,
                                         disabled=True)

        row2 = ft.Row([self.dd, self.btnRagg], alignment=ft.MainAxisAlignment.CENTER)
